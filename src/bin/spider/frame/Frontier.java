...
import bin.spider.frame.CrawlSubstats;
import bin.spider.frame.CrawlSubstats.HasCrawlSubstats;
 ...
 * {@link bin.spider.frame.archive.crawler.framework.CrawlController CrawlController} which
 ...
 * {@link bin.spider.frame.archive.crawler.framework.CrawlController CrawlController}.
 ...
 *
 * @see bin.spider.frame.archive.crawler.framework.CrawlController
 * @see bin.spider.frame.archive.crawler.framework.CrawlController#fireCrawledURIDisregardEvent(CrawlURI)
 * @see bin.spider.frame.archive.crawler.framework.CrawlController#fireCrawledURIFailureEvent(CrawlURI)
 * @see bin.spider.frame.archive.crawler.framework.CrawlController#fireCrawledURINeedRetryEvent(CrawlURI)
 * @see bin.spider.frame.archive.crawler.framework.CrawlController#fireCrawledURISuccessfulEvent(CrawlURI)
