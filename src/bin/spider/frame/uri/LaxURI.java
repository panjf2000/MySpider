...
import bin.httpclient3.uri.EncodingUtil;
import bin.httpclient3.uri.URI;
...
public class LaxURI extends URI {
     ...
     * instances.  
     * 
     * @see bin.httpclient3.uri.httpclient.URI#parseAuthority(java.lang.String, boolean)
     */
     ...
     * per instance. 
     * 
     * @see bin.httpclient3.uri.httpclient.URI#setURI()
     */
