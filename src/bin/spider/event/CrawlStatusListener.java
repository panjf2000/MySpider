 ...
 *
 * @see bin.spider.frame.archive.crawler.framework.CrawlController#addCrawlStatusListener(CrawlStatusListener)
 */
...
public interface CrawlStatusListener {
     ...
     *
     * @see bin.spider.frame.archive.crawler.admin.CrawlJob
     */
     ...
     * {@link bin.spider.frame.archive.crawler.admin.CrawlJob#STATUS_WAITING_FOR_PAUSE
     ...
     *
     * @param statusMessage Should be
     * {@link bin.spider.frame.archive.crawler.admin.CrawlJob#STATUS_PAUSED}. Passed for
     * convenience
     */
     ...
     *
     * @param statusMessage Should be
     * {@link bin.spider.frame.archive.crawler.admin.CrawlJob#STATUS_RUNNING}. Passed for
     * convenience
     */
